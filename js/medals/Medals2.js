...
Medals.prototype.init = function(opt){
	...
	this.loadModel(function(object){
		...
		self.object.position.set(0, 50 ,0);
...
Medals.prototype.setColor = function(color){
	...
	var HSL = new THREE.Color( '#ff8b52' ).getHSL({ h: 0, s: 0, l: 0 });
	HSL.s *= 0.5;
	chibang.material.color = new THREE.Color('#ff8b52');
	...
	var HSL = new THREE.Color( '#ff8b52' ).getHSL({ h: 0, s: 0, l: 0 });
	HSL.s *= 0.5;
	shangjiao.material.color = new THREE.Color('#ff8b52');
	...
	var HSL = new THREE.Color( '#fff99e' ).getHSL({ h: 0, s: 0, l: 0 });
	HSL.s *= 0.5;
	sanjiao3.material.color = new THREE.Color('#fff99e');
	...
	var HSL = new THREE.Color( '#fff99e' ).getHSL({ h: 0, s: 0, l: 0 });
	HSL.s *= 0.5;
	sanjiao2.material.color = new THREE.Color('#fff99e');
	...
	var HSL = new THREE.Color( '#fff99e' ).getHSL({ h: 0, s: 0, l: 0 });
	HSL.s *= 0.5;
	sanjiao1.material.color = new THREE.Color('#fff99e');
...
Medals.prototype.setText = function(text){
	...
	loader.load( '../models/fonts/fang.json', function ( response ) {
		...
		let materials = [
			new THREE.MeshPhongMaterial( { color: 0xc8d5ef, flatShading: true } ), // front
